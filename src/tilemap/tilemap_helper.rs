...
pub fn load_levels() -> Vec<Tilemap> {
    ...
    let tilemap = Tilemap::from_pyxeledit(Rect::new(0.0, 0.0, 128.0, 128.0), String::from_utf8(tiles_json_vec).unwrap().as_str());
    let tilemap2 = Tilemap::from_pyxeledit(Rect::new(0.0, 0.0, 128.0, 128.0), String::from_utf8(tiles_json_vec2).unwrap().as_str());
    let tilemap3 = Tilemap::from_pyxeledit(Rect::new(0.0, 0.0, 128.0, 128.0), String::from_utf8(tiles_json_vec3).unwrap().as_str());
